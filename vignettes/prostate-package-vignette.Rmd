...
Title} %\VignetteEngine{knitr::knitr} %\VignetteEncoding{UTF-8} ---
...
### Patient-level data
```{r, results = "hide"}
#setwd("/Users/jbindman/Desktop/JHU/Prostate/prostate-project/vignettes")
getwd()
...
```{r, results = "hide"}
#setwd("/Users/jbindman/Desktop/JHU/Prostate/prostate-project/R")
#need dplyr for filter with subj
