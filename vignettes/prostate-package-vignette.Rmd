...
#names(demo_data)
#{r} denotes to run and print the code. it allows me to read in demo_data here, but if I add {r} to the next pieces of code, it is unable to Knit HTML. Additionally, there is some output from running the code that I don't want printed (see box with lines beginng ## just above)
```
