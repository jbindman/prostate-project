#rm(list=ls())
#setwd("/Users/ryc/Documents/inhealth/prediction-model/for-julia/IOP")


# This function will plot patient data using the "shaped" data. It isn't necessary to prep the data and arguments for jags. 
# We may want to separate fillPatientTables function from the other prep jags functions. Then, we can save those dataframes for this and other visualization functions
